...
Config.SkinnableAnimals = {
    ...
    [1110710183]  = { name = "Deer", givenItem = { "meat" }, givenAmount = { 2 }, givenDisplay = {}, money = 0, gold = 0, rolPoints = 0, xp = 1 },
    ...
    [-2063183075]  = { name = "Dominique Chicken", givenItem = { "feathers" }, givenAmount = { 3 }, givenDisplay = {}, money = 0, gold = 0, rolPoints = 0, xp = 3 },
}
